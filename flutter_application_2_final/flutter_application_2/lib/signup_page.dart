...
class _SignupPageState extends State<SignupPage> {
  ...
  final TextEditingController _emailConfirmController = TextEditingController(); // Email confirm controller
  ...
  String? _emailError;
  String? _emailConfirmError; // Email confirm error
  ...
  Future<void> _signup() async {
    setState(() {
      ...
      _usernameError = null;
      _emailError = null;
      _emailConfirmError = null; // Clear email confirm error
      _passwordError = null;
    ...
    String confirmEmail = _emailConfirmController.text.trim(); // Confirm email
    ...
    // Check if email confirmation matches the first email field
    ...
    try {
      // Attempt to create a new user with the email and password
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(
                    ...
                    errorText: _emailConfirmError, // Error for email confirmation
                  ),
                  _buildPasswordField(
                    "كلمة المرور",
                    Icons.lock,
