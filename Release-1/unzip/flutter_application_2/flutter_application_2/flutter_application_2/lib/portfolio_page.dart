                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 4),
                            Text('66,379 (24.65%)', style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            SizedBox(width: 4),
                            Text('66,379 (24.65%)', style: TextStyle(color: Color(0xFF9DC08B), fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ],
                    )
