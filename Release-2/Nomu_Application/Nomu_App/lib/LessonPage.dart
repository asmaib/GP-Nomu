        ...
        return FutureBuilder<Map<String, dynamic>?>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || snapshot.data == null) {
              return const Scaffold(
                body: Center(child: Text("لم يتم العثور على الدرس")),
              );
            }
                  ...
                  child: isLandscape
                      ? Center(
                          child: AspectRatio(
                            ...
                            child: _youtubeController != null
                                ? YoutubePlayer(
                                    key:
                                        const ValueKey('lesson_youtube_player'),
                      ...
                      : ListView(
                          children: [
                            ...
                            if (widget.lessonDocId != 'tutorial')
                              Padding(
